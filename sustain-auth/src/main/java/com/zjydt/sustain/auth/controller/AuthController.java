package com.zjydt.sustain.auth.controller;

import com.zjydt.sustain.auth.query.OAuth2AccessTokenQuery;
import com.zjydt.sustain.common.constants.CommonConstants;
import com.zjydt.sustain.common.constants.SecurityConstants;
import com.zjydt.sustain.common.service.RedisService;
...
public class AuthController {
    ...
    public ApiResult getTokenList(OAuth2AccessTokenQuery oAuth2AccessTokenQuery) {
        ...
        oAuth2AccessTokenQuery.setRecords((List)redisTemplate.opsForList().range(CommonConstants.SUSTAIN_REDIS_LIST_LEY, oAuth2AccessTokenQuery.getStart(), oAuth2AccessTokenQuery.getEnd()));
        List<OAuth2AccessToken> all = (List)redisTemplate.opsForList().range(CommonConstants.SUSTAIN_REDIS_LIST_LEY, 0, -1);
        if(all != null){
