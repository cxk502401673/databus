package com.zjydt.sustain.common.constants;
...
public interface SecurityConstants {
   ...
   String CLOUD = "sustain";

   String CLOUD_PREFIX = "sustain_";

    /**
     * jwt 加密key
     */
   String SIGN_KEY = "SUSTAIN";
   ...
   String REDIS_CODE_PREFIX = "sustain_code_";
