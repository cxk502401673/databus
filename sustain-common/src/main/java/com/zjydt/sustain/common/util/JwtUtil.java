...
public class JwtUtil {
     ...
     * @return JWT字符串
     */
    public static String buildJWT(Map<String, Object> claim, SignatureAlgorithm alg, Key key, String sub, String aud, String jti,
                                  String iss, Date nbf, Integer duration) {
        // jwt的签发时间
     ...
     * @return JWT字符串
     */
    public static String buildJWT(Map<String, Object> claim, String sub, String aud, String jti, String iss, Date nbf, Integer duration) {
        return buildJWT(claim, JWT_ALG, generateKey(JWT_ALG, JWT_RULE), sub, aud, jti, iss, nbf, duration);
    }
     ...
     * @return JWT字符串
     */
    public static String buildJWT(Map<String, Object> claim, String sub, String jti, Integer duration) {
        return buildJWT(claim, sub, null, jti, null, null, duration);
    }
     ...
     * @return JWT字符串
     */
    public static String buildJWT(Map<String, Object> claim, String sub) {
        return buildJWT(claim, sub, null, UUID.randomUUID().toString(), null, null, 600);
    }
     ...
     * @return
     */
    public static String buildJWT(Map<String, Object> claim, String sub, Integer duration) {
        return buildJWT(claim, sub, null, UUID.randomUUID().toString(), null, null, duration);
    }
     ...
     * @return ture or false
     */
    public static Boolean checkJWTByKey(String claimsJws, String keystr) {
        boolean flag = false;
        try {
            SecretKey key = generateKey(JWT_ALG, keystr);
            // 获取 JWT 的 payload 部分
            flag = (parseJWT(key, claimsJws).getBody() != null);
        } catch (Exception e) {
            log.warn("JWT验证出错，错误原因：{}", e.getMessage());
